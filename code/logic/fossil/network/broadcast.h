 ...
 * -----------------------------------------------------------------------------
 */
#ifndef FOSSIL_NETWORK_BROADCAST_H
#define FOSSIL_NETWORK_BROADCAST_H
...
// ------------------------------
typedef struct fossil_network_broadcast_t {
    fossil_network_socket_t sock;
} fossil_network_broadcast_t;
...
#endif /* FOSSIL_NETWORK_BROADCAST_H */
